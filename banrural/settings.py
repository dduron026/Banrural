import django
"""
Django settings for banrural project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'cobranzas', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
            ...
            'builtins': [
                'general.templatetags.extras',
            ]
        },
    },
]

WSGI_APPLICATION = 'banrural.wsgi.application'
...
#         'USER': 'userCRM',                      # Not used with sqlite3.
